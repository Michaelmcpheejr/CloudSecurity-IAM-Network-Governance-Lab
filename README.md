Cloud Security IAM & Network Governance Lab (Azure)
...
Implement RBAC at resource group, resource, and subnet level

Enforce least privilege through scoped role assignments

Secure Azure Storage with private access and granular data roles

Analyze Azure Activity Logs to validate access and configuration changes

Review Defender for Cloud baseline recommendations
...
Subnet-level micro-segmentation

Principle of Least Privilege

Cloud governance & compliance mapping
